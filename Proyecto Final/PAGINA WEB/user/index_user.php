...
session_start();
cabecera("Index_user","styles.css");
...
<style>
    ...
    /* Estilo para encabezados h1 y h2 */
    h1, h2 {
        font-family: 'Roboto', sans-serif;
        font-weight: bold;
        font-size: 2.4em;
    ...
    /* Estilo para el texto debajo de "Comparación de Alumnos Contratados" */
    div > div > p {
        font-weight: bold;
    }
    ...
    <div style="width: 48%;">
        ...
        <div id="chart-container-alum" style="width: 100%; height: 400px;">
            ...
            <div>
                ...
                <p style="<?php echo ($diff_alum < 0) ? 'color: red;' : ($diff_alum > 0 ? 'color: green;' : 'color: steelblue;'); ?>">El número de alumnos este año es de: <?=$n_alum?>.<br> 
                    <?php
                        if ($diff_alum > 1) {
                            echo "Este año han habido " . abs($diff_alum) . " alumnos más";
                        } elseif ($diff_alum < 0) {
                            echo "Este año han habido " . abs($diff_alum) . " alumnos menos";
                        }
                        elseif ($diff_alum == 1) {
    ...
    <div style="width: 48%;">
        ...
        <div id="chart-container-asig" style="width: 100%; height: 400px;">
            ...
            <div>
                ...
                <p style="<?php echo ($diff_asig < 0) ? 'color: red;' : ($diff_asig > 0 ? 'color: green;' : 'color: steelblue;'); ?>">El número de asignaciones este año es de: <?=$n_asig?>.<br> 
                    <?php
                        if ($diff_asig > 1) {
                            echo "Este año han habido " . abs($diff_asig) . " asignaciones más";
                        } elseif ($diff_asig < 0) {
                            echo "Este año han habido " . abs($diff_asig) . " asignaciones menos";
                        }
                        elseif ($diff_asig == 1) {
